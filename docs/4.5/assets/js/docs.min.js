...
$('div.highlight').each(function(){var btnHtml='<div class="bd-clipboard"><button type="button" class="btn-clipboard" title="Скопировать в буфер обмена">Копировать</button></div>'
$(this).before(btnHtml)
...
clipboard.on('success',function(e){$(e.trigger).attr('title','Скопировано!').tooltip('_fixTitle').tooltip('show').attr('title','Скопировать в буфер обмена').tooltip('_fixTitle')
e.clearSelection()})
clipboard.on('error',function(e){var modifierKey=/mac/i.test(navigator.userAgent)?'\u2318':'Ctrl-'
var fallbackMsg='Press '+modifierKey+'C to copy'
$(e.trigger).attr('title',fallbackMsg).tooltip('_fixTitle').tooltip('show').attr('title','Скопировать в буфер обмена').tooltip('_fixTitle')})
...
return origin}
window.docsearch({apiKey:'11d7cdbc7ad186db4e2493f9c0d3aa1c',indexName:'bootstrap-su',inputSelector:'#search-input',algoliaOptions:{facetFilters:['version:'+siteDocsVersion]},transformData:function(hits){return hits.map(function(hit){var currentUrl=getOrigin()
